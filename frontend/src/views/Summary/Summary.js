                ...
                <div className="summary">
                    ...
                    <div className="summary__summ">
                        ...
                        <div className="summ-data">
                            <p><b>All items cost: </b><span>{cart.itemsPrice.toFixed(2)} $</span></p>
                            <p><b>Shipping cost: </b><span>{cart.shippingPrice.toFixed(2)} $</span></p>
                            <p><b>Tax: </b><span>{cart.taxPrice.toFixed(2)} $</span></p>
                            <p id="summ-total"><b>Total cost: </b><span>{cart.totalPrice.toFixed(2)} $</span></p>
                        </div>
