        ...
        <div>
        {
            ...
            : <div className="cart__wrapper">
                        ...
                        cartItems.map((item, index) => (
                            <tbody>
                                <tr key={index}>
                                    ...
                                    <td>{Math.round((item.price * item.quantity + Number.EPSILON) * 100) / 100}zł</td>
                                    <td>
                ...
                <div className="cart__summary">
                    <hr/>
                    <h3>Cart total</h3>
                    <h2>{Math.round((cartItems.reduce((accumulator, current) => accumulator + current.price * current.quantity, 0) + Number.EPSILON) * 100) / 100}zł</h2>
