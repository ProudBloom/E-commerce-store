        ...
        <div className="payment__wrapper">
            ...
            <div className="payments">
                ...
                {/* TODO: implement buttons as radio (so user can't unfocus them) */}
                    ...
                    <button id="paypal-button" onClick={ () => setPaymentMethod('Przelewy24') } className="payment__button">
                    <svg width="600" height="204" viewBox="0 0 600 204" xmlns="http://www.w3.org/2000/svg">
